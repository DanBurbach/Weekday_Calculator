...
describe('date object', function() {
  let weekCalc;
  beforeEach(function(){
    weekCalc = new WeekCalc(1978, 3, 12);
  });
  ...
  //   expect(weekCalc.doomDay()).toEqual(7);
  // })

  it('should calculate the numeric value of a day based off of its doomsday date', function(){
    expect(weekCalc.doomCalculate()).toEqual(0);
  })
